...
static void r321_heri_down()
{
    ...
    EvtMgr.EvtReadExec("event/evd/r321s00.evd", 0, EvtReadFlagNone);
...
void setTexRender()
{
    ...
    if (GetTexRenderMgr(&r321_work->tex)) {
        ...
        tbl[1] = 0;
        tbl[4] = 0xF7;
        tbl[5] = r321_work->tex->GetTexNo();
        r321_work->tex->SetRepeatType(1);
        EstSet(0, -1, 0, 0, EFF_ROOM, 0, r321_work->tex->GetCoreFlg() | 1, ESP_CORE_KIND_NONE, 0, 0);
    } else {
