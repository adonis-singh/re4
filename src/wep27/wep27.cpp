...
void cObjMachinegun::setMotion(cPlayer* pl)
{
    ...
    PSet(pl->m_MotTbl[0x03], WEP_ARC_PTR(0x14));
    ...
    PSet(pl->m_MotTbl[0x0D], WEP_ARC_PTR(0x12));
    PSet(pl->m_MotTbl[0x0E], WEP_ARC_PTR(0x18));
    PSet(pl->m_MotTbl[0x0F], WEP_ARC_PTR(0x13));
