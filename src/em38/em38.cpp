...
static EmAtkInfo em38_atk_tbl[5] = {
    { 1000.0f, 8, 500, 0, 0xA, 0 },
    { 1000.0f, 8, 0, 0, 0xA, 0 },
    { 1000.0f, 8, 500, 0, 0xA, 0 },
    { 1800.0f, 8, 9999, 0, 0xA, 0 },
    { 1800.0f, 8, 800, 0, 0xA, 0 },
};
...
static void em38_R0_Init(cEm38* em)
{
    ...
    if (em->type == 0) {
        EstSet((int) em, -1, 0, 0, 0x2E, 4, 1, w->espKind2, (u32) em, 0);
    }
...
static void em38_R1_HeadStamp(cEm38* em)
{
    ...
    switch (em->r_no_2) {
    case 0:
        MotionSetCore(em, MOTION(em), ARC(0x13), (int) ARC(0x14), 30, 1, 0);
        if (w->pTent[0]) {
        ...
        w->blendRate = 0.0f;
        EstSet((int) em, -1, 0, 0, 0x2E, 0xF, 1, w->espKind, (u32) em, 0);
        w->atkHit = 0;
        em->r_no_2++;
    case 1:
        if (MotionMoveF(em, 0)) {
...
static void em38_R1_Atk(cEm38* em)
{
    ...
    case 0:
        ...
        EstSet((int) em, -1, 0, 0, 0x2E, 6, 1, w->espKind, (u32) em, 0);
        w->timer = 15;
        em->r_no_2++;
    case 1:
        w->flags |= 0x80;
...
static void em38_R1_T_In(cEm38* em)
{
    ...
    case 0:
        if (em->type == 2) {
            MotionSetCore(em, MOTION(em), ARC(0x30), 0, 0, 5, 0);
            EstSet(0, -1, 0, 0, 0x2E, 0x1F, 1, w->espKind, (u32) em, 0);
        } else {
            MotionSetCore(em, MOTION(em), ARC(0x30), 0, 0, 0x45, 0);
            EstSet(0, -1, 0, 0, 0x2E, 0x21, 1, w->espKind, (u32) em, 0);
        }
        EstSet((int) em, -1, 0, 0, 0x2E, 0x23, 1, w->espKind, (u32) em, 0);
        w->atkWait = 0;
...
static void em38_R1_T_Out(cEm38* em)
{
    ...
    case 0:
        ...
        if (em->type == 2) {
            ...
            EstSet(0, -1, 0, 0, 0x2E, 0x20, 1, w->espKind, (u32) em, 0);
        } else {
...
static void em38_R1_T_Atk(cEm38* em)
{
    ...
    case 0:
        ...
        if (em->type == 2) {
            ...
            w->mot[2] = ARC(0x36);
            w->blendKind = 1;
            EstSet((int) em, -1, 0, 0, 0x2E, 0x16, 1, w->espKind, (u32) em, 0);
        } else {
            w->mot[0] = ARC(0x34);
            w->mot[3] = ARC(0x35);
            w->mot[1] = ARC(0x36);
            w->mot[2] = ARC(0x37);
            w->blendKind = 0x41;
            EstSet((int) em, -1, 0, 0, 0x2E, 0x17, 1, w->espKind, (u32) em, 0);
        }
        ...
        if (end) {
            ...
            if (w->timer && w->atkHit == 0 && w->escaped == 0) {
                ...
                if ((pPLS->pos.x < -3000.0f && em->type == 1) || (pPLS->pos.x > 3000.0f && em->type == 2)) {
                    if (pPL->r_no_0 == 4) {
                        if (w->actVar) {
                            ActBtn.set(0x25, 0xB, (int) em38EscapeAction, (int) em, 3, 3, 0, 0);
                        } else {
                            ActBtn.set(0x25, 0xB, (int) em38EscapeAction, (int) em, 3, 4, 0, 0);
                        }
                    } else {
                        if (w->actVar) {
                            ActBtn.set(0x25, 0xB, (int) em38EscapeAction, (int) em, 1, 3, 0, 0);
                        } else {
                            ActBtn.set(0x25, 0xB, (int) em38EscapeAction, (int) em, 1, 4, 0, 0);
                        }
                    }
                }
            }
...
static void em38_R1_T_MdlAtk(cEm38* em)
{
    ...
    case 0:
        if (em->type == 2) {
            MotionSetCore(em, MOTION(em), ARC(0x32), (int) ARC(0x33), 10, 1, 0);
            EstSet((int) em, -1, 0, 0, 0x2E, 0x14, 1, w->espKind, (u32) em, 0);
        } else {
            MotionSetCore(em, MOTION(em), ARC(0x32), (int) ARC(0x33), 10, 0x41, 0);
            EstSet((int) em, -1, 0, 0, 0x2E, 0x15, 1, w->espKind, (u32) em, 0);
        }
        em38SetTentAtkWait(w);
        w->atkHit = 0;
        w->escaped = 0;
        ...
        if (end) {
            ...
            if (w->timer2) {
                ...
                if ((pPLS->pos.x < 4000.0f && em->type == 1) || (pPLS->pos.x > -4000.0f && em->type == 2)) {
                    if (pPL->r_no_0 == 4) {
                        if (w->actVar) {
                            ActBtn.set(0x25, 0xB, (int) em38BackjumpAction, (int) em, 3, 3, 0, 0);
                        } else {
                            ActBtn.set(0x25, 0xB, (int) em38BackjumpAction, (int) em, 3, 4, 0, 0);
                        }
                    } else {
                        if (w->actVar) {
                            ActBtn.set(0x25, 0xB, (int) em38BackjumpAction, (int) em, 1, 3, 0, 0);
                        } else {
                            ActBtn.set(0x25, 0xB, (int) em38BackjumpAction, (int) em, 1, 4, 0, 0);
                        }
                    }
                }
            }
...
static void em38_R1_T_BigAtk(cEm38* em)
{
    ...
    case 0:
        if (em->type == 2) {
            MotionSetCore(em, MOTION(em), ARC(0x3A), (int) ARC(0x3B), 10, 1, 0);
            EstSet((int) em, -1, 0, 0, 0x2E, 0x1B, 1, w->espKind, (u32) em, 0);
        } else {
            MotionSetCore(em, MOTION(em), ARC(0x3C), (int) ARC(0x3D), 10, 0x41, 0);
            EstSet((int) em, -1, 0, 0, 0x2E, 0x1A, 1, w->espKind, (u32) em, 0);
        }
        em38SetTentAtkWait(w);
        w->atkHit = 0;
        w->escaped = 0;
            ...
            if (w->timer2) {
                ...
                if ((pPLS->pos.x < 6000.0f && em->type == 1) || (pPLS->pos.x > -6000.0f && em->type == 2)) {
                    if (pPL->r_no_0 == 4) {
                        if (em->type == 1) {
                            if (w->actVar) {
                                ActBtn.set(0x25, 0xB, (int) em38SitAction, (int) em, 3, 3, 0, 0);
                            } else {
                                ActBtn.set(0x25, 0xB, (int) em38SitAction, (int) em, 3, 4, 0, 0);
                            }
                        } else {
                            if (w->actVar) {
                                ActBtn.set(0x25, 0xB, (int) em38BackjumpAction, (int) em, 3, 3, 0, 0);
                        ...
                        if (em->type == 1) {
                            if (w->actVar) {
                                ActBtn.set(0x25, 0xB, (int) em38SitAction, (int) em, 1, 3, 0, 0);
                            } else {
                                ActBtn.set(0x25, 0xB, (int) em38SitAction, (int) em, 1, 4, 0, 0);
                            }
                        } else {
                            if (w->actVar) {
                                ActBtn.set(0x25, 0xB, (int) em38BackjumpAction, (int) em, 1, 3, 0, 0);
...
static void em38_R1_T_DownAtk(cEm38* em)
{
    ...
    case 0:
        if (em->type == 2) {
            MotionSetCore(em, MOTION(em), ARC(0x38), (int) ARC(0x39), 10, 1, 0);
            EstSet((int) em, -1, 0, 0, 0x2E, 0x18, 1, w->espKind, (u32) em, 0);
        } else {
            MotionSetCore(em, MOTION(em), ARC(0x38), (int) ARC(0x39), 10, 0x41, 0);
            EstSet((int) em, -1, 0, 0, 0x2E, 0x19, 1, w->espKind, (u32) em, 0);
        }
        em38SetTentAtkWait(w);
        w->atkHit = 0;
        em->r_no_2++;
...
static void em38_R1_T_CatchHit(cEm38* em)
{
    ...
    case 0:
        ...
        w->timer = 91;
        EstSet((int) em, -1, 0, 0, 0x2E, 7, 0, 0, (u32) em, 0);
        em->r_no_2++;
    case 1:
...
static void plem38_CatchHit(cPlayer* pl)
{
    ...
    case 0:
        ...
        EstSet((int) pl, -1, 0, 0, 0x2E, 0xE, 0, 0, (u32) pl, 0);
        PlSetFace(1);
        pl->r_no_2++;
    case 1:
        if (MotionMoveF(pl, 0)) {
    ...
    case 2:
        ...
        EstSet((int) pl, -1, 0, 0, 0x2E, 0x1C, 0, 0, (u32) pl, 0);
        pl->r_no_2++;
    case 3:
        if (MotionMoveF(pl, 0)) {
            EndPlDamage();
...
static void em38_R1_Dm_Down(cEm38* em)
{
    ...
    case 3:
        ...
        break;
    case 4:
        MotionSetCore(em, MOTION(em), ARC(0x18), (int) ARC(0x19), 3, 1, 0);
        em->r_no_2++;
    case 5:
        if (MotionMoveF(em, 0)) {
...
void em38ShellControl(cEm38* em)
{
    ...
    case 2:
        ...
        EstSet((int) em, -1, 0, 0, 0x2E, 5, 0, 0, (u32) em, 0);
    case 3:
        MotionMoveCore(em, SHELL_MOT(w), 0);
    ...
    case 0xA:
        ...
        w->mode++;
        SndCall(8, 0x12, &em->pos, em->id, 0, em);
        EstSet((int) em, -1, 0, 0, 0x2E, 0x24, 0, 0, (u32) em, 0);
    case 0xB:
        MotionMoveCore(em, SHELL_MOT(w), 0);
        if (MotionSequenceCtrl(SHELL_MOT(w))) {
            w->mode = 4;
...
void em38BloodSet(cEm38* em)
{
    ...
    if (em->type == 0) {
        if (part->partsNo == 0x3B) {
            ...
            case 0x26:
            case 0x2B:
                EstSet((int) em, -1, 0, 0, 0x2E, 9, 0, 0, (u32) em, 0);
                break;
            case 0xB:
            case 0xC:
            case 0x1B:
            case 0x1D:
            case 0x27:
                EstSet((int) em, -1, 0, 0, 0x2E, 0xA, 0, 0, (u32) em, 0);
                break;
            case 7:
            case 8:
            case 0x21:
...
void em38YarareInitBody(cEm38* em)
{
    ...
    YarareInit(em, 0.0f, 0.0f, 0.0f, 1000.0f, 1000.0f, 3, 5);
    YarareAdd(em, &w->hit[0], 0.0f, 0.0f, 0.0f, 1000.0f, 1000.0f, 4, 5);
    YarareAdd(em, &w->hit[1], 0.0f, 0.0f, 0.0f, 1000.0f, 500.0f, 5, 5);
    YarareAdd(em, &w->hit[2], 0.0f, -800.0f, 1000.0f, 1100.0f, 1000.0f, 5, 5);
    YarareAdd(em, &w->hit[3], 0.0f, 0.0f, 0.0f, 500.0f, 1000.0f, 0x12, 5);
    YarareAdd(em, &w->hit[4], 0.0f, 0.0f, 0.0f, 500.0f, 1000.0f, 0x13, 5);
    YarareAdd(em, &w->hit[5], 0.0f, 0.0f, 0.0f, 500.0f, 1000.0f, 0x14, 5);
    YarareAdd(em, &w->hit[6], 0.0f, 0.0f, 0.0f, 500.0f, 1000.0f, 0x15, 5);
    YarareAdd(em, &w->hit[7], 0.0f, 0.0f, 0.0f, 500.0f, 1000.0f, 0x16, 5);
    YarareAdd(em, &w->hit[8], 0.0f, 0.0f, 0.0f, 500.0f, 1000.0f, 0x17, 5);
    YarareAdd(em, &w->hit[9], 0.0f, 0.0f, 0.0f, 500.0f, 1000.0f, 0x18, 5);
    YarareAdd(em, &w->hit[10], 0.0f, 0.0f, 0.0f, 500.0f, 1000.0f, 0x19, 5);
    YarareAdd(em, &w->hit[11], 0.0f, -100.0f, 0.0f, 650.0f, 900.0f, 0x1A, 5);
    YarareAddCube(em, &w->hit[12], -500.0f, -200.0f, 0.0f, 500.0f, 200.0f, 500.0f, 6, 1);
    YarareAddCube(em, &w->hit[13], -500.0f, -200.0f, 400.0f, 500.0f, 200.0f, 1200.0f, 7, 1);
    YarareAddCube(em, &w->hit[14], -500.0f, -100.0f, 200.0f, 500.0f, 200.0f, 900.0f, 8, 1);
    YarareAddCube(em, &w->hit[15], -500.0f, -200.0f, 0.0f, 700.0f, 200.0f, 900.0f, 9, 1);
    YarareAddCube(em, &w->hit[16], -500.0f, -200.0f, 200.0f, 700.0f, 200.0f, 1000.0f, 0xA, 1);
    YarareAddCube(em, &w->hit[17], -500.0f, -100.0f, 300.0f, 700.0f, 200.0f, 700.0f, 0xB, 1);
    YarareAddCube(em, &w->hit[18], 500.0f, -200.0f, 0.0f, 500.0f, 200.0f, 700.0f, 0xC, 1);
    YarareAddCube(em, &w->hit[19], 500.0f, -200.0f, 400.0f, 500.0f, 200.0f, 1200.0f, 0xD, 1);
    YarareAddCube(em, &w->hit[20], 500.0f, -100.0f, 200.0f, 500.0f, 200.0f, 900.0f, 0xE, 1);
    YarareAddCube(em, &w->hit[21], 500.0f, -200.0f, 0.0f, 700.0f, 200.0f, 900.0f, 0xF, 1);
    YarareAddCube(em, &w->hit[22], 500.0f, -200.0f, 0.0f, 700.0f, 200.0f, 1000.0f, 0x10, 1);
    YarareAddCube(em, &w->hit[23], 500.0f, -100.0f, 0.0f, 700.0f, 200.0f, 700.0f, 0x11, 1);
    YarareAdd(em, &w->hit[24], 0.0f, 0.0f, 20.0f, 320.0f, 0.0f, 0x3B, 1);
...
void em38YarareInitTentacle(cEm38* em)
{
    ...
    YarareInit(em, 0.0f, 0.0f, 0.0f, 1000.0f, 2000.0f, 2, 5);
    YarareAdd(em, &w->hit[0], 0.0f, 0.0f, 0.0f, 950.0f, 1900.0f, 3, 5);
    YarareAdd(em, &w->hit[1], 0.0f, 0.0f, 0.0f, 900.0f, 1800.0f, 4, 5);
    YarareAdd(em, &w->hit[2], 0.0f, 0.0f, 0.0f, 860.0f, 1700.0f, 5, 5);
    YarareAdd(em, &w->hit[3], 0.0f, 0.0f, 0.0f, 820.0f, 1600.0f, 6, 5);
    YarareAdd(em, &w->hit[4], 0.0f, 0.0f, 0.0f, 800.0f, 1500.0f, 7, 5);
    YarareAdd(em, &w->hit[5], 0.0f, 0.0f, 0.0f, 760.0f, 1400.0f, 8, 5);
    YarareAdd(em, &w->hit[6], 0.0f, 0.0f, 0.0f, 720.0f, 1300.0f, 9, 5);
    YarareAdd(em, &w->hit[7], 0.0f, 0.0f, 0.0f, 680.0f, 1200.0f, 0xA, 5);
    YarareAdd(em, &w->hit[8], 0.0f, 0.0f, 0.0f, 640.0f, 1100.0f, 0xB, 5);
    YarareAdd(em, &w->hit[9], 0.0f, 0.0f, 0.0f, 600.0f, 1000.0f, 0xC, 5);
    YarareAdd(em, &w->hit[10], 0.0f, 0.0f, 0.0f, 560.0f, 900.0f, 0xD, 5);
    YarareAdd(em, &w->hit[11], 0.0f, 0.0f, 0.0f, 520.0f, 800.0f, 0xE, 5);
    YarareAdd(em, &w->hit[12], 0.0f, 0.0f, 0.0f, 480.0f, 700.0f, 0xF, 5);
    YarareAdd(em, &w->hit[13], 0.0f, 0.0f, 0.0f, 440.0f, 600.0f, 0x10, 5);
    YarareAdd(em, &w->hit[14], 0.0f, 0.0f, 0.0f, 400.0f, 500.0f, 0x11, 5);
...
void em38YarareInitUpper(cEm38* em)
{
    ...
    YarareInit(em, 0.0f, 0.0f, 0.0f, 400.0f, 200.0f, 2, 1);
    YarareAdd(em, &w->hit[0], 0.0f, 0.0f, 0.0f, 400.0f, 100.0f, 3, 1);
    YarareAdd(em, &w->hit[1], 0.0f, 0.0f, 0.0f, 300.0f, 200.0f, 6, 1);
    YarareAdd(em, &w->hit[2], 0.0f, -300.0f, 0.0f, 150.0f, 300.0f, 0xB, 1);
    YarareAdd(em, &w->hit[3], 0.0f, -300.0f, 0.0f, 150.0f, 300.0f, 0xC, 1);
    YarareAdd(em, &w->hit[4], 0.0f, -300.0f, 0.0f, 150.0f, 300.0f, 0xD, 1);
    YarareAdd(em, &w->hit[5], 0.0f, 0.0f, 0.0f, 200.0f, 400.0f, 0x11, 3);
    YarareAdd(em, &w->hit[6], 0.0f, 0.0f, 0.0f, 120.0f, 400.0f, 0x12, 3);
...
void em38YarareInitLower(cEm38* em)
{
    ...
    YarareInitCube(em, 0.0f, -2000.0f, 0.0f, 2000.0f, 4000.0f, 1500.0f, 3, 1);
    YarareAdd(em, &w->hit[0], 0.0f, 500.0f, 0.0f, 2800.0f, 0.0f, 0x10, 1);
...
static void plemDmStamp(cPlayer* pl)
{
    ...
    case 0:
        if ((s16) pG->pl_life <= 0) {
            ...
            EstSet((int) pl, -1, 0, 0, 0x2E, 0xD, 0, 0, (u32) pl, 0);
            PlSetDamageSe(0xD);
        } else {
            MotionSetCore(pl, MOTION(pl), PL_ARC(0x48), 0, 5, 1, 0);
            EstSet((int) pl, -1, 0, 0, 0x2E, 0xC, 0, 0, (u32) pl, 0);
            PlSetDamageSe(0);
        }
        PlSetFace(1);
        pl->r_no_2++;
...
static void plemEscape(cPlayer* pl)
{
    ...
    case 0: {
        ...
        if (side) {
            MotionSetCore(pl, MOTION(pl), PL_ARC(0x4A), (int) PL_ARC(0x4B), 5, 1, 0);
        } else {
